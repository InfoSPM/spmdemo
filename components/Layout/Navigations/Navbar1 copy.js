                                ...
                                >
                                  <div className="single-what-we-do-box purple-color">
                                    ...
                                    <ul className="megamenu-submenu">
                                      ...
                                      <li className="nav-item">
                                        <Link
                                          href="/applications-managed-services-support"
                                          activeClassName="active"
                                        >
                                      ...
                                      <li className="nav-item">
                                        <Link
                                          href="/consulting-advisory-services"
                                          activeClassName="active"
                                        >
                                          <a className="nav-link">
                                      ...
                                      <li className="nav-item">
                                        <Link
                                          href="/infrastructure-outsourcing"
                                          activeClassName="active"
                                        >
                                      ...
                                      <li className="nav-item">
                                        <Link href="/aws-cloud-services" activeClassName="active">
                                ...
                                >
                                  <div className="single-what-we-do-box purple-color">
                                    ...
                                    <ul className="megamenu-submenu">
                                      ...
                                      <li className="nav-item">
                                        <Link
                                          href="/custom-solutions-development"
                                          activeClassName="active"
                                        >
                                          <a className="nav-link">
