            ...
            <div className="overview-item-style-two">
              <div className="row align-items-center">
                ...
                >
                  <img
                    src={
                      salesIncrease?.data?.attributes?.image?.data?.attributes?.url
                    }
                    alt={
                      salesIncrease?.data?.attributes?.image.data.attributes
                        .alternativeText
                    }
                  />
                </div>
                ...
                <div className="col-lg-6 col-md-12 overview-content">
                  ...
                  <p>{salesIncrease?.data?.attributes?.shortText}</p>
                  <ul className="overview-list">
                    {salesIncrease?.data?.attributes?.card.map((info) => (
                      <li
                        data-aos="fade-up"
                        data-aos-duration="1200"
                        key={info.id}
            ...
            <div className="overview-item-style-two">
              <div className="row align-items-center">
                <div className="col-lg-6 col-md-12 overview-content">
                  ...
                  <p>{riskManagement?.data?.attributes?.shortText}</p>
                  <ul className="overview-list">
                    {riskManagement?.data?.attributes?.card.map((info) => (
                      <li
                        data-aos="fade-up"
                        data-aos-duration="1200"
                        key={info.id}
                ...
                >
                  <img
                    src={
                      riskManagement?.data?.attributes?.image?.data?.attributes?.url
                    }
                    alt={
                      riskManagement?.data?.attributes?.image.data.attributes
                        .alternativeText
                    }
                  />
                </div>
